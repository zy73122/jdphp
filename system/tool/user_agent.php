...
$ua = new user_agent();
$operateing_sys_info = $ua->getOperatingSystem($user_agent);
$browser_info = $ua->getBrowser($user_agent);

//MOMO_3G 是判断为智能手机 MOMO_WAP是非智能手机，除此之外就是PC
if (($operateing_sys_info ['id'] == 'AND' || 
			$operateing_sys_info ['id'] == 'IPH' || 
			$operateing_sys_info ['id'] == 'IPD' || 
			$operateing_sys_info ['id'] == 'WEBOS' || 
			$operateing_sys_info ['id'] == 'KIT') && 
		($browser_info ['id'] == 'SF' || 
		 $browser_info ['id'] == 'CH' || 
		 $browser_info ['id'] == 'KIT')) {
	//header ( "Location:" . MOMO_3G );
} elseif($operateing_sys_info ['id'] == 'SYM' || 
		$operateing_sys_info ['id'] == 'NOKIA' ||
		$operateing_sys_info ['id'] == 'J2ME' || 
		$browser_info ['id'] == 'UC') {
	//header ( "Location:" . MOMO_WAP );
} else {
	echo 'PC';
}
?>
...
class user_agent
{
	...
	public static function getBrowserNameFromId($browserId)
	{
		self::init();
	...
	public static function getBrowserShortNameFromId($browserId)
	{
		self::init();
	...
	public static function getOperatingSystemShortNameFromId($osId)
	{
		self::init();
