...
define('AUTHOR_CODE_GDFONTS', PATH_ROOT . 'static/authcode/gdfonts/bubblebath.gdf');
define('AUTHOR_CODE_FONT', PATH_ROOT . 'static/authcode/font/elephant.ttf');
...
class securimage
{
	 ...
	 * @var mixed
	 */
	var $gd_font_file = AUTHOR_CODE_GDFONTS;
	/**
