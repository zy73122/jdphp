...
class securimage {
	...
	*/
	...
	function Securimage()
	{
		...
		$this->wordlist_file = PATH_TOOL . 'securimage/words/words.txt';
		$this->use_wordlist  = false;

		$this->gd_font_file  = PATH_TOOL . 'securimage/gdfonts/automatic.gdf';
		$this->use_gd_font   = false;
		$this->gd_font_size  = 24;
		$this->text_x_start  = 15;

		$this->ttf_file	  = PATH_TOOL . 'securimage/AHGBold.ttf';
	...
	$this->text_color	   = new Securimage_Color(0x3d, 0x3d, 0x3d);
		...
		$this->signature_font  = PATH_TOOL . 'securimage/AHGBold.ttf';

		$this->audio_path   = PATH_TOOL . 'securimage/audio/';
		$this->audio_format = 'mp3';
		$this->session_name = '';
		$this->expiry_time  = 900;
		
		$this->sqlite_database = PATH_TOOL . 'securimage/database/securimage.sqlite';
